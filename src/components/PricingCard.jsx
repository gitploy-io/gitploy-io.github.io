...
export default function PricingCard() {
  const price = 50
  const options = [10, 15, 20, 25, 30, 35, 40];
    ...
    <Card>
      <Row>
        ...
        >
          ...
          >
            If you would like to purchase a subscription for 40+ developers please <a href="mailto:support@gitploy.io" target="_blank">Contact Sales.</a>
          </p>
        </Col>
        <Col 
          span={12}
